...
class ClientMessageSection:
    ...
    def showEmptyBanner (self):
        # message banner
        self.defaultImage = Image.open(os.path.join(os.path.dirname(__file__),"../../../assets/img/message-default.png"))
        self.contentEmptyBanner = customtkinter.CTkImage(dark_image=self.defaultImage,size=(300, 200))
        self.contentEmptyBannerImage = customtkinter.CTkLabel(self.contentFrame, image=self.contentEmptyBanner, text=" ", fg_color="transparent", anchor="center")
